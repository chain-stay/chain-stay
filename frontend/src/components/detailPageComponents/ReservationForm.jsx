...
const ReservationForm = () => {
  ...
  const handleClickButton = (e) => {
    ...
    if (account) {
      ...
      navigate(
        `/paymentPage?checkInDate=${checkInDate}&checkOutDate=${checkOutDate}&guests=${guests}`
      );
    } else {
      setIsOpen(true);
    }
  ...
  return (
    <OrderContainer>
      ...
      <ReserveSubTitle>$ 3.2s / night</ReserveSubTitle>
    ...
    </OrderContainer> //! 버튼 누르면 내용 같이 넘어가야 함
  );
};
